...
#include "win32_windowsThrowMacros.h"
...
std::optional<int> win32_window::ProcessMessages() noexcept
{
	MSG msg;
...
void win32_window::FreeCursor() noexcept
{
	ClipCursor( nullptr );
}

void win32_window::HideCursor() noexcept
{
	while( ::ShowCursor( FALSE ) >= 0 );
}

void win32_window::ShowCursor() noexcept
{
	while( ::ShowCursor( TRUE ) < 0 );
}

LRESULT CALLBACK win32_window::HandleMsgSetup( HWND hWnd,UINT msg,WPARAM wParam,LPARAM lParam ) noexcept
{
...
LRESULT CALLBACK win32_window::HandleMsgThunk( HWND hWnd,UINT msg,WPARAM wParam,LPARAM lParam ) noexcept
{
...
LRESULT win32_window::HandleMsg( HWND _hWnd,UINT msg,WPARAM wParam,LPARAM lParam ) noexcept
{
    switch( msg )
	{
...
win32_window::HrException::HrException( int line,const char* file,HRESULT hr ) noexcept
	:
	Exception( line,file ),
	hr( hr )
{}
...
std::string win32_window::HrException::GetErrorDescription() const noexcept
{
...
{
	return "win32_window Exception [No Graphics]";
}